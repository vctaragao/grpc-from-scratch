...
type SayHelloClient interface {
	HelloMessage(ctx context.Context, in *Request, opts ...grpc.CallOption) (*Response, error)
}
...
func (c *sayHelloClient) HelloMessage(ctx context.Context, in *Request, opts ...grpc.CallOption) (*Response, error) {
	out := new(Response)
	err := c.cc.Invoke(ctx, "/SayHello/HelloMessage", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type SayHelloServer interface {
	HelloMessage(context.Context, *Request) (*Response, error)
...
func (UnimplementedSayHelloServer) HelloMessage(context.Context, *Request) (*Response, error) {
...
func _SayHello_HelloMessage_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(Request)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(SayHelloServer).HelloMessage(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/SayHello/HelloMessage",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(SayHelloServer).HelloMessage(ctx, req.(*Request))
	}
	...
	Methods: []grpc.MethodDesc{
		{
			...
			Handler:    _SayHello_HelloMessage_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "protobuf/hello_word_service.proto",
}
